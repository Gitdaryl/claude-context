...
## 2026-08-20 13:59 AEST

## Session: 2026-08-20 ET
**Environment:** Antigravity IDE

**What was done:**
- Pulled up prior Decker & Sons work (July 22 pitch package, SEO audit, plain-English handout) before brainstorming, so nothing was repeated or lost.
- Brainstormed the post-discovery proposal set around Kathy's actual brief: presence not virality, new things nobody local has done, AI Kathy persona modeled on the Sam Quisenberry build.
- Confirmed the underwriter is Auto-Owners and built compliance flagging into every item (Clear / Wants a look / Needs signoff), with a printed Plan B beside every flagged item and a 4-rung fallback ladder for AI Kathy.
- Built the full printable options menu: 30 items, 7 sections, 3 bundles, plus a separately page-breaking internal page of meeting-running notes.
- Flagged the Michigan anti-rebating issue (no gift cards or prizes for reviews) and the co-op advertising question for Auto-Owners.
- Saved the new-homeowner welcome packet idea to auto-memory as a product to develop.

**What's live / deployed:**
- Options menu artifact: https://claude.ai/code/artifact/202f0985-2010-4533-a7ac-f98f9401ae72
- Source HTML: ~/Archive/Clients/Decker-Insurance/decker-options-menu.html

**Next up:**
- Print and take to the next Decker meeting (no date set).
- Ask Kathy about Auto-Owners co-op advertising dollars.
- Develop the realtor-branded new-homeowner welcome packet into a two-sided sponsor product (agency buys the folder, local businesses buy the inserts). Natural first pairing: Mitchel Ramsey as the agency, Decker as an insert sponsor.

**Notes for other environments:**
- The August menu supersedes the July idea menu; the July SEO audit is still the evidence document behind the Foundation section.
- AI Kathy is the marquee item and Sam Quisenberry's videos (in ~/Archive/Clients/Sam-Insurance) are the live proof to show in the room.

---

## 2026-08-20 14:47 AEST

## Session: 2026-08-20 ET
**Environment:** Antigravity IDE

**What was done:**
- Pulled up the July Decker & Sons work (pitch package, SEO audit, plain-English handout) before brainstorming, so nothing was repeated or dropped.
- Built one printable Decker options menu over four passes: 30 items across 7 sections, compliance flags (Clear / Wants a look / Needs signoff), a printed Plan B on every flagged line, and a 4-rung fallback ladder for AI Kathy.
...
- Reworked the bundles after finding they were sums rather than discounts. Now $1,450 / $550 per mo / $995 per mo, first-year build included free on both monthlies, savings printed in dollars using the low end of every range.
...
**What's live / deployed:**
- Options menu artifact (client pages first, internal pages page-break separately): https://claude.ai/code/artifact/202f0985-2010-4533-a7ac-f98f9401ae72
- Source HTML: ~/Archive/Clients/Decker-Insurance/decker-options-menu.html
- Nothing deployed to any site this session. No code changed.

**Next up:**
- Print and take to the next Decker meeting, no date set. Queue a Sam Quisenberry video before sitting down; the "will AI Kathy look fake" question is only answerable by playing one.
- Ask Kathy whether Auto-Owners offers co-op advertising dollars.
- TWO OPEN CODE ITEMS on manitoubeachmichigan.com, both needed before a free listing is handed over: no Insurance category in LISTING_CATEGORIES, and SLOT_CAPS is empty so "top of category" is not enforced (the prep sheet's exclusivity answer relies on it). Board row filed as Today.
...
## 2026-08-23 11:39 AEST

## Session: 2026-08-23 ET
**Environment:** Antigravity IDE
**What was done:**
- Built the print-ready package for the Noe Law appointment (Thursday Sep 3): Desktop/Noe-Law-Sep3-Appointment/ with 9 numbered PDFs
- 00 agenda + attorney questions (updated with appointment date), 01 Signature Films service agreement draft, 02 Owls Nest venue agreement draft, 03 Owls Nest liability waiver draft, 04-06 live MB privacy/terms/advertising agreement, 07 live yetigroove terms, 08 yetigroove homepage (privacy + SMS sections)
- Live pages printed straight from production URLs so the attorney reviews exactly what users see; verified renders page by page
- Canonical agenda at ~/Archive/Business/attorney-review-package.md now carries the appointment header

**What's live / deployed:**
- Nothing new deployed; PDFs are local

**Next up:**
- Yeti: print the folder contents (Finder: select all 9, File > Print) and bring to Noe Law Sep 3
- Yeti: email zoning administrator for written micro-wedding clearance BEFORE the appointment so Noe can see the wording
- After appointment: apply attorney edits to all drafts, then convert venue docs to signable PDFs

**Notes for other environments:**
- If Yeti reports attorney feedback from mobile after Sep 3, the documents to amend live in: Yeti-Groove repo docs/ (service agreement), Desktop OWLS-NEST-*.md (venue docs), MB repo src/pages (site policies), Yeti-Groove repo (yetigroove policies)

---

## 2026-08-25 11:08 AEST

## Session: August 25, 2026 ET
**Environment:** Antigravity IDE

**What was done:**
- Read Joe Profit's Aug 22 email answering the six treatment questions (via Gmail connector, which needed authorizing first).
- Applied his notes, then reviewed them properly and found three problems.
- **Wrong doc.** `Joe-Profit/movie/` is the July 13 draft (ends at the 1971 draft, no present-day frame). It was superseded July 18 by the v2 site treatment: tracks cold open, Marcus mentorship frame, IHOP deed as climax. Reverted my edits, added ARCHIVED banners pointing at the live version.
- **Joe's 1962 / age 13 date is contradicted by his own book** in three places: Selma is the stated motivation, the Civil Rights Act is the scene's legal premise (Title II, July 1964, so no law existed to cite in 1962), and the courthouse is at fourteen. Book math puts him at 15 in 1965. The treatment's "nineteen" is also wrong, that is Grandma's cousin Henry.
- **Declined Joe's barn cold open.** It spends Session Five's climax in minute one, which is the exact argument the Film Structure page makes to him, and his own bridge line cancels the suspense he says he is protecting. Adopted everything else: all his barn payoff notes (verified verbatim from the book) and his time-card request, since the film genuinely inverts chronology at Session Four.
- Flagged independent craft gaps: the IHOP climax has no scene or obstacle, Act II is summary not scenes, Marcus turns off-screen after Session Five.
- Yeti asked about planting hidden white text to make Joe's ChatGPT reveal itself. Declined and built the open equivalent, since Joe had already disclosed AI use in his own email.

**What's live / deployed:**
- https://never-broken-site.vercel.app/continuity — Joe-facing Continuity Record. Timeline of record with the three 1965 anchors quoted from the book, the locked "first Black athlete at a predominantly white four-year college in Louisiana" wording, names, ten verbatim lines to protect, three lines written for the film that were being mistaken for memory, unsourced claims, five open questions. 28 note anchors so Joe can comment paragraph by paragraph. Verified by content, not just a 200.
- Added `vercel.json` cleanUrls. Internal review docs kept OUT of the site repo, since Vercel serves any file in it publicly even though the repo is private.

**Next up:**
- Yeti sends `~/Documents/Joe-Profit/email-joe-short-2026-08-25.md`. No memory questions in it, so Joe arrives at the call unprepped.
- Yeti sets up recording and books an hour or two with Joe. Only Joe's side needs quality: his phone voice recorder is the master, Zoom local is backup and sync. Consent on tape in the first ten seconds.
- Fix the live logline, still says "breaks the color line in his conference".
- Write the IHOP deed climax as an actual scene, dramatize Act II, source or cut the 169-yard Bengals claim, add place-and-year cards, send Dave the structure ruling.

**Notes for other environments:**
- **The canonical treatment is the site (`~/never-broken-site/treatment.html`, v2 Jul 18), NOT `Joe-Profit/movie/`.** The movie folder is archived. Do not edit or cite it.
- Joe uses AI to draft his replies and said so himself. Treat his texture and dialogue notes as authoritative and his dates and structural claims as needing verification against the book (`Archive/Clients/Joe-Profit/Never Broken Audiobook.txt`).
- Working docs now live in `~/Documents/Joe-Profit/`: STRUCTURE-REVIEW, INTERVIEW-GUIDE, CONTINUITY-RECORD, and both email drafts.
- Still open from July: the ULM40 Stripe promotion code, in Today since Jul 20, 36 days.

---

## 2026-08-25 18:18 AEST
...
## 2026-09-12 21:42 AEST

## Session: 2026-09-12 ET
**Environment:** Antigravity IDE
**What was done:**
- Car search narrowed from Venza/RAV4/NX shortlist to a 2022-2024 RAV4 Hybrid, XLE or Limited, on 17"/18" wheels (retracted the earlier road-noise objection: 72 dB vs Venza 71.5 dB; the reputation is the XSE's 20" wheels)
- Fact-checked a "6 flagship SUVs cheaper than a RAV4" YouTube video claim-by-claim: prices accurate, but it omits ~16 mpg on premium (~$3k/yr) and never quantifies the repair fund; its own "buy the paperwork" advice contradicts its bottom-of-market headline prices
- Killed the Lexus NX 350h financial case: same 39 mpg as Venza, 25E used-EV credit terminated Sept 30 2025 (never covered non-plug-in hybrids anyway), standard mileage rate (72.5c/76c 2026) favors the cheaper car; ~$13k for comfort only
- Surfaced "Cablegate" (HV cable corrosion, salt-accelerated, ~$5k): avoid 2019-21, VIN-check 2022-24 for the warranty extension and preventive fix
- Compared two live KBB listings (Toledo $26k/81k mi vs Brighton $32k/47.5k mi + Weather Package); recommended Brighton; taught cost-per-remaining-mile framework
- Fact-checked Toyota solid-state hype: real, but 2027-28 as a $110-137k Lexus EV, mainstream 2030+, five timeline slips; advised against an interim cheap car (detour costs ~$5-7k)
- Published lot-sheet artifact with trims, years, Michigan checks, and a persistent checklist

**What's live / deployed:**
- Artifact: https://claude.ai/code/artifact/c2c1213c-630a-4e8d-a22e-d02261283f7d (RAV4 Hybrid Lot Sheet)
- Memory car-search-2026.md rewritten with the decision and rules

**Next up:**
- Yeti: pull CARFAX on the Toledo car (fleet/rental check); get in-service date on the Brighton car (powertrain warranty); VIN cable check with a Toyota dealer; independent lift inspection for salt rust; confirm Cherokee engine (2.4 vs 3.2)

**Notes for other environments:**
- Personal purchase, not a client task; nothing filed on the Master Task Board
- If Yeti brings more car videos, the pattern is omission not lying: check mpg, fuel grade, and repair costs first

---

## 2026-09-13 11:48 AEST
...
## 2026-09-15 14:28 AEST

## Session: 2026-09-15 ET
**Environment:** Antigravity IDE
**What was done:**
- DLYC previz: read Wilson L.01/L.02 (both revisions), the nadir aerial, two lake-side drone plates, the east-side pano, old boathouse east/west, and four golden-hour dock frames into `~/Projects/Yeti-Groove/docs/DLYC-PREVIZ-SPEC.md` (gitignored, repo is public, never commit it).
- Facts that matter: lake is NORTH, parking and entrance SOUTH, old boathouse EAST of the club. Site drops 12.5 ft parking to water (F.F.F. 1058.22, beach 1045.7). Wilson sheets predate Aug 26; their boathouse is the old combined building and no pavilion is drawn anywhere. The lake-side porch (white square posts, curved knee-brace brackets, scalloped spandrels, low hip shingle roof) is the design key for the pavilion.
- Rebuilt the concept prompts around the real building: E1-E3 edit the drone plates, T1-T3 are text backups. Rule: edit the plate, never regenerate the club.
- Flag bunting in the photos is USA 250 seasonal dressing, excluded from every reference and prompt.
- Board rows filed: "DLYC concept renders" (In Progress) and "ask Craig/Otis: pavilion sketch, boathouse levels, Krieghoff consent" (Today). Session Brain row written. Memory: dlyc-site-shot-list.md.
- Hours log started at the bottom of the spec; Yeti to fill today's number.

**What's live / deployed:**
- Nothing. Spec and memory on disk only.

**Next up:**
- Yeti is on site shooting phone stills against the 12-item shot list (in the spec, in memory, and in the Session Brain row). Overcast is fine for 1-9; items 10-12 wait for a golden-hour sky.
- Then IDE runs E2 (tight boathouse edit) and E1 (wide After) on the drone plates via Higgsfield. Files are on the NAS at `personal folder/yeti groove/clients/DLYC previz` (mount was slow to answer this session, not yet verified).
- Yeti to send Craig/Otis the five questions in the Today board row, pavilion location being the big one.

**Notes for other environments:**
- Mobile: when Yeti sends a site photo and asks if it is right, check it against the numbered "right when" lines in the Session Brain row dated 2026-09-15 (or memory file dlyc-site-shot-list.md), and say which numbers are still open.
- Cowork: nothing needed yet. Image generation stays in IDE for this one because the prompts edit local drone plates.

---

## 2026-09-15 14:40 AEST
...
## 2026-09-18 18:01 AEST


## Session: 2026-09-18 (ET)
**Environment:** Antigravity IDE
**What was done:**
- Sunny Skies website strategy: fetched eriehome.com, Erie's FB landing page, and callsunnyskies.com; strategy = fight on proof + price transparency, not tenure/claims.
- Built clickable mockup artifact (strategy-notes toggle explains every block vs Erie vs current site): price-range estimator replaces the contact form, storm-mode banner, no-pressure promise, follow-up timeline, live-reviews layout, skeptic FAQ, $199/mo financing example.
- Scrub hero rebuilt on REAL plates: trusses -> decking drops in bands -> shingles land course-by-course along the real shingle lines -> lands on real drone photo (Adrian job). WebGL, 3 WebP plates + course map, 790KB. Ken Burns / stills-motion explicitly rejected by Yeti.
- Plates registered (homography), roof mask from deck-vs-final diff, course directions from structure tensor. Pipeline in ~/Desktop/sunny-skies/scrub/ (venv + work/), publish copy in ~/Desktop/sunny-skies/mockup/.

**What's live / deployed:**
- Mockup artifact: https://claude.ai/code/artifact/b6dea0fd-105f-4793-9ec2-ab4258b4ed41 (private artifact, not a deploy)

**Next up:**
- Yeti reviews hero on a real phone; possible tweaks: heavier drop / dust / wave across planes.
- Real numbers needed before anything ships: price bands from Isaac's last 12 months, "% inspections end with not yet", license numbers, lender rate/term, "nothing paid until material on driveway" is a business decision for Isaac.
- Assets still wanted: 6-9 before/after pairs by town (9:16 originals, no baked chips), Isaac from-street photo + quote clip from Sep 11 shoot, GBP ID for live reviews.
- Then cut into a real Next/Vercel build.

**Notes for other environments:**
- Rule reaffirmed: AI may clean up / stylize (falling shingles is obviously designed), never invent the finished roof; the final frame must be the real photo.
- Sunny Skies does occasional full replacements (trusses stage is true for them; Yeti filmed two).

---

## 2026-09-18 22:08 AEST


## Session: 2026-09-18 (evening ET)
**Environment:** Antigravity IDE
**What was done:**
- Design review of the Sunny Skies homepage mockup (artifact b6dea0fd) against eriehome.com asphalt page, legacyroofingltd.com and callsunnyskies.com
- Published a Design canvas: https://claude.ai/artifact/27PrGWfo7siHs5QP7mvxoC (5 boards: verdict scorecard, Maslow/lead-path map, six ranked changes, modified desktop 1280, modified phone 390)
- Verdict: keep the architecture (price before phone, proof over adjectives); six changes: range before any chip (9 decisions to 2), hero form = estimator step 1 with proof badges beside it and scrub cut to ~160vh, proof wall (shingle spec + color row + license/insurance/manufacturer links, the one gap vs Erie), storm ribbon above the nav, roof-count size cue in trust strip, financing disclaimer + FAQ cut to five

**What's live / deployed:**
- Nothing deployed; canvas is private until shared

**Next up:**
- Yeti decides which of the six to apply to the mockup; then edit artifact b6dea0fd (publish copy in ~/Desktop/sunny-skies/mockup/)
- Facts still blocked on Isaac: price bands from invoices, shingle line + wind/impact ratings, MI/OH license numbers, manufacturer cert, roof count, lender APR + disclaimer, "% not yet" figure

**Notes for other environments:**
- Design canvas is the Design artifact type (boards under project/); edit via Artifact tool, not the mockup HTML

---

## 2026-09-18 23:32 AEST
